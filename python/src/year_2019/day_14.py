...
class Solution2019Day14(Solution):
    ...
    def solve(self, inputs: Inputs) -> None:
        for sample in inputs.samples:
            ...
            required_ore_for_1 = self.get_ore_requirement(reactions, "FUEL", 1, defaultdict(int))
    ...
    @staticmethod
    def prepare(data: str) -> dict[str, Reaction]:
        ...
        for line in data.splitlines():
            ...
            reactions[right[1]] = Reaction(quantity=int(right[0]), input=input_chemicals)
        return reactions
    ...
    def solve_2(self, reactions: dict[str, Reaction], required_ore_for_1: int) -> int:
        available_ore = 1_000_000_000_000
        excess: DefaultDict[str, int] = defaultdict(int)
