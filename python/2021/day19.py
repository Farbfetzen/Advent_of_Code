...
SAMPLE_PATH = "../../input/2021-19-sample.txt"
INPUT_PATH = "../../input/2021-19-input.txt"
...
if __name__ == "__main__":
    ...
    assert part_1(sample_data) == 79
    assert part_2(sample_data) == 3621

    challenge_data = get_data(INPUT_PATH)
    print(part_1(challenge_data))  # 451
    print(part_2(challenge_data))  # 13184
